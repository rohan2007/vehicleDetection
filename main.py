...
video_detector.detectObjectsFromVideo(input_file_path="video.mp4", frames_per_second=20, per_frame_function=forFrame, minimum_percentage_probability=70, output_file_path="analyzed_video.mp4")
